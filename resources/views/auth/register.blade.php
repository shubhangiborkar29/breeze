        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
              ...
              <div>
                ...
                <x-input id="phone_number" class="block mt-1 w-full" type="integer" name="phone_number" :value="old('phone_number')" required autofocus />
            </div>
            ...
            <!-- Pincode -->
            <div>
                 <x-label for="pin_code" :value="__('pincode')" />

                 <x-input id="pin_code" class="block mt-1 w-full" type="integer" name="pin_code" :value="old('pin_code')" required autofocus />
            </div>
            <div class="mt-4">
